    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
        ...
        <div className="px-6 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white mb-1">إدارة السلوكيات</h1>
                <p className="text-white/90">تسجيل ومتابعة سلوك الطلاب</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="p-6">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-12 text-center border-2 border-gray-200 shadow-lg">
          ...
          <p className="text-gray-600">صفحة السلوكيات قيد التطوير</p>
        </div>
      </div>
    </div>
  )
